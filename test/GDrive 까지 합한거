...
def create_image():
    ...
    # 이미지를 로드하고 크기 조정
    image1 = Image.open("C:\\tf\\New\\image1.jpg")
    image2 = Image.open("C:\\tf\\New\\image2.jpg")
    image3 = Image.open("C:\\tf\\New\\image3.jpg")
    image4 = Image.open("C:\\tf\\New\\image4.jpg")
...
def run_script():
    ...
    desktop_path = os.path.expanduser("C:\\tf\\output")
...
def create_qr_code():
    ...
    file1.SetContentFile('C:\\tf\\output\\output.jpg') 
    file1.Upload()
